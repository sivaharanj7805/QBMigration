...
def test_caseware_exporter():
    ...
    test_data = {
        ...
        'accounts': [
            {'AccountNumber': '1000', 'Name': 'Cash', 'AccountType': 'Bank', 'Balance': 50000},
            {'AccountNumber': '1200', 'Name': 'AR', 'AccountType': 'Accounts Receivable', 'Balance': 25000},
            {'AccountNumber': '2000', 'Name': 'AP', 'AccountType': 'Accounts Payable', 'Balance': 15000},
            {'AccountNumber': '7000', 'Name': 'Livestock', 'AccountType': 'Livestock', 'Balance': 100000},
            {'AccountNumber': '7100', 'Name': 'WIP', 'AccountType': 'Work in Process', 'Balance': 45000}
        ],
        'invoices': [
            {'TxnID': 'INV-001', 'RefNumber': '1001', 'TxnDate': '2026-01-15', 'Amount': 5000},
            {'TxnID': 'INV-002', 'RefNumber': '1002', 'TxnDate': '2026-01-16', 'Amount': 3500}
        ],
        'bills': [
            {'TxnID': 'BILL-001', 'RefNumber': 'B-100', 'TxnDate': '2026-01-10', 'Amount': -2500}
        ]
    }
    ...
    if 'global_file_hash' in exporter.stats:
        print(f"  [PASS] Global File Hash: {exporter.stats['global_file_hash'][:16]}...")
    else:
...
def test_data_transformer_caseware_mode():
    ...
    test_data = {
        ...
        'accounts': [
            {'AccountNumber': '1000', 'Name': 'Chequing', 'AccountType': 'Bank', 'Balance': 75000}
        ]
    }
