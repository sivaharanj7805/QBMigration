...
class TrialBalanceError(ValidationError):
    ...
    def __init__(
        self, debits: str, credits: str, difference: str, details: dict = None
    ):
        message = (
        ...
        details = details or {}
        details.update({"debits": debits, "credits": credits, "difference": difference})
        super().__init__(message, None, details)
        self.code = "VAL003"
...
class BatchError(QBOAPIError):
    ...
    def __init__(
        self, succeeded: int, failed: int, errors: list = None, details: dict = None
    ):
        message = (
        ...
        details = details or {}
        details.update(
            {"succeeded": succeeded, "failed": failed, "errors": errors or []}
        )
