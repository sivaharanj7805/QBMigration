...
class TestLicenseAPI:
    ...
    def test_license_validate_missing_fingerprint(self, client, db_session):
        ...
        response = client.post('/api/license/validate', json={
            'license_key': 'FB-TEST-XXXX-YYYY-ZZZZ'
        })
    ...
    def test_license_use_migration(self, client, db_session):
        ...
        response = client.post('/api/license/use-migration', json={
            'license_key': license.license_key,
            'hardware_fingerprint': fingerprint,
    ...
    def test_license_expired(self, client, db_session):
        ...
        fingerprint = 'test-fingerprint'
        license = License.create_license(tier='starter', expires_in_days=-1)  # Already expired
        license.activate(fingerprint)
        db_session.add(license)
        db_session.commit()
    ...
    def test_license_usage_endpoint(self, client, db_session):
        ...
        response = client.post('/api/license/usage', json={
            'license_key': license.license_key,
            'hardware_fingerprint': fingerprint
        })
...
class TestLicenseModel:
    ...
    def test_to_dict(self, db_session):
        ...
        license = License.create_license(tier='professional', user_email='test@example.com')
