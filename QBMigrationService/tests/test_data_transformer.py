...
class TestIDMapping:
    ...
    def test_store_mapping_skips_none(self, transformer):
        ...
        assert (
            "Customer" not in transformer.id_mapping
            or len(transformer.id_mapping["Customer"]) == 0
        )
...
class TestEntityTransformations:
    ...
    def test_transform_vendor_basic(self, transformer):
        ...
        qbd_vendor = {"Name": "Supplier Inc", "IsActive": True, "Balance": 500.00}
...
class TestTrialBalance:
    ...
    def test_debit_account_positive_balance(self, transformer):
        ...
        qbd_account = {"Name": "Cash", "AccountType": "Bank", "Balance": 1000.00}
