        ...
        try:
            response = self.kms_client.create_key(
                ...
                Tags=[
                    ...
                    {"TagKey": "Environment", "TagValue": os.environ.get("ENV", "production")}
                ]
            )
    ...
    def _load_or_generate_key(self):
        ...
        if os.path.exists(key_path):
            ...
            logger.warning(
                ...
                "For production, use AWS KMS instead."
            )
