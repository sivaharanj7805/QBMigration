...
def generate_report(session_id):
    ...
    try:
        ...
        c.setFont('Helvetica', 11)
        c.drawString(50, height - 225, 'Your QuickBooks file has been analyzed and is ready for migration.')
        ...
        c.drawString(50, 50, '© 2026 ForensicBridge. Enterprise-grade QuickBooks migration.')
