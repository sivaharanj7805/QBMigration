...
class TestRunner:
    ...
    def run_integration_tests(self):
        ...
        test_file = (
            self.root_dir / "QBMigrationService" / "tests" / "test_integration.py"
        )
    ...
    def check_qbo_connection(self):
        ...
        try:
            ...
            response = requests.get(
                "https://sandbox-quickbooks.api.intuit.com/v3/company/info", timeout=10
            )
...
def main():
    ...
    parser.add_argument(
        "--service-only", action="store_true", help="Run only service tests"
    )
    parser.add_argument(
