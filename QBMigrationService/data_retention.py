...
class DataRetentionManager:
    ...
    def _load_jobs(self):
        ...
        if os.path.exists(self.jobs_file):
            try:
                ...
                logger.warning(f"Warning: Could not load deletion jobs: {e}")
    ...
    def _save_jobs(self):
        ...
        try:
            ...
            logger.warning(f"Warning: Could not save deletion jobs: {e}")
    ...
    def _execute_deletion(self, job):
        ...
        if failed_count > 0:
            logger.error(f"  Failed: {failed_count} files")
