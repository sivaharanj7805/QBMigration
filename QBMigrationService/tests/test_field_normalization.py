...
class TestNormalizeExtractorFieldsLineItems:
    ...
    def test_invoice_lines(self):
        entity = {
            'txnId': 'INV-001',
            'lines': [
                {'itemRefListId': 'I1', 'description': 'Widget', 'quantity': 5, 'rate': 10.00, 'amount': 50.00},
            ],
        }
    ...
    def test_bill_lines_split_expense_and_item(self):
        ...
        entity = {
            'txnId': 'BILL-001',
            'lines': [
                {'accountRefListId': 'ACC-001', 'description': 'Office Rent', 'amount': 2000.00},
                {'itemRefListId': 'ITEM-001', 'description': 'Supplies', 'quantity': 10, 'rate': 5.00, 'amount': 50.00},
                {'accountRefListId': 'ACC-002', 'description': 'Utilities', 'amount': 300.00},
            ],
        }
    ...
    def test_bill_expense_lines_normalized(self):
        ...
        entity = {
            'txnId': 'BILL-001',
            'lines': [
                {'accountRefListId': 'ACC-001', 'description': 'Rent', 'amount': 2000.00},
            ],
        }
        result = QBDataTransformer.normalize_extractor_fields(entity, 'Bill')
    ...
    def test_bill_item_lines_only(self):
        ...
        entity = {
            'txnId': 'BILL-003',
            'lines': [
                {'itemRefListId': 'ITEM-001', 'quantity': 5, 'rate': 20.00, 'amount': 100.00},
            ],
        }
        result = QBDataTransformer.normalize_extractor_fields(entity, 'Bill')
        assert 'ItemLines' in result
    ...
    def test_journal_entry_lines(self):
        entity = {
            'txnId': 'JE-001',
            'lines': [
                {'accountRefListId': 'ACC-001', 'amount': 1000.00, 'journalLineType': 'Debit'},
                {'accountRefListId': 'ACC-002', 'amount': 1000.00, 'journalLineType': 'Credit'},
            ],
        }
    ...
    def test_sales_receipt_lines(self):
        entity = {
            'txnId': 'SR-001',
            'lines': [{'itemRefListId': 'I1', 'quantity': 2, 'rate': 25.00, 'amount': 50.00}],
        }
    ...
    def test_purchase_order_lines(self):
        entity = {
            'txnId': 'PO-001',
            'lines': [{'itemRefListId': 'I1', 'quantity': 100, 'rate': 5.00, 'amount': 500.00}],
        }
    ...
    def test_inventory_adjustment_lines(self):
        ...
        result = QBDataTransformer.normalize_extractor_fields(entity, 'InventoryAdjustment')
    ...
    def test_multiple_line_items_all_normalized(self):
        ...
        entity = {
            'txnId': 'INV-004',
            'lines': [
                {'itemRefListId': 'I1', 'quantity': 1, 'rate': 100.00, 'amount': 100.00},
    ...
    def test_entity_type_case_insensitive(self):
        ...
        result_lower = QBDataTransformer.normalize_extractor_fields(entity_lower, 'invoice')
        result_mixed = QBDataTransformer.normalize_extractor_fields(entity_mixed, 'Invoice')
...
class TestEndToEndIntegration:
    ...
    def test_normalize_then_transform_accounts(self, transformer):
        ...
        normalized = QBDataTransformer.normalize_extractor_fields(camel_account, 'Account')
    ...
    def test_normalize_then_transform_customer(self, transformer):
        ...
        normalized = QBDataTransformer.normalize_extractor_fields(camel_customer, 'Customer')
    ...
    def test_normalize_then_transform_vendor(self, transformer):
        ...
        normalized = QBDataTransformer.normalize_extractor_fields(camel_vendor, 'Vendor')
    ...
    def test_transform_handles_all_camel_case_entity_types(self, transformer):
        ...
        data = {
            'accounts': [
                {'listId': 'A1', 'name': 'Checking', 'accountType': 'bank', 'balance': 500, 'isActive': True},
            ],
            'paymentMethods': [
    ...
    def test_transform_preserves_trial_balance(self, transformer):
        ...
        data = {
            'accounts': [
                {'listId': 'A1', 'name': 'Cash', 'accountType': 'bank', 'balance': 10000, 'isActive': True},
                {'listId': 'A2', 'name': 'Revenue', 'accountType': 'income', 'balance': 10000, 'isActive': True},
            ],
        }
